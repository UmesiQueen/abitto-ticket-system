...
const SeatSelection = () => {
  ...
  return (
    <div className=" w-full max-w-[1000px] h-full md:h-[550px] rounded-lg bg-white py-5 px-3 md:px-5 grid gap-y-8 md:gap-0 md:grid-cols-2 md:grid-rows-2 mx-auto">
      ...
      <div className="order-3 md:col-start-1 md:row-start-2 gap-8 flex flex-col px-3 md:pr-0 md:mt-20">
        <input
          disabled
          value={seatSelected}
